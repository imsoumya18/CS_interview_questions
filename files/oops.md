...
**6. What is encapsulation? How is it achieved in C++?**
...
**7. Describe the concept of inheritance and its types.**
...
**8. How does C++ support multiple inheritance?**
...
**9. What is a constructor? Differentiate between a default constructor and a parameterized constructor.**
...
**10. What is a destructor? Why is it used?**
...
**11. How do you create a copy constructor in C++?**
...
**13. Explain the difference between `delete` and `delete[]`.**
...
**15. Provide an example of function overloading in C++.**
...
**16. How is function overriding achieved in C++?**
...
**17. What is a virtual function? How is it useful?**
...
**18. Define a pure virtual function. What is its significance?**
...
**19. What are abstract classes and abstract methods in C++?**
...
**20. How can you prevent a class from being instantiated in C++?**
...
**21. Explain the concept of friend functions in C++?**
...
**22. What is the role of the `static` keyword in C++?**
...
**23. How is memory allocated for objects in C++?**
...
**24. Describe the difference between shallow copy and deep copy.**
...
**25. What are smart pointers in C++? Provide examples.**
...
**26. How are namespaces used in C++?**
...
**27. Explain the purpose of the `const` keyword in C++?**
...
**28. What are access specifiers? Provide their significance.**
...
**29. How do you handle exceptions in C++ using `try`, `catch`, and `throw`?**
...
**30. Discuss the differences between `std::vector` and C-style arrays.**
...
**31. Explain the use of the `const` member function in C++?**
...
**32. What is the role of the `mutable` keyword in C++?**
...
**33. How do you implement operator overloading for a user-defined class?**
...
**34. What is a friend class in C++?**
...
**35. Describe the process of dynamic casting in C++?**
...
**36. What are the differences between `static_cast`, `dynamic_cast`, `const_cast`, and `reinterpret_cast`?**
...
**37. What are virtual destructors? Why are they important?**
...
**38. Discuss the concept of a template in C++?**
...
**39. What are the advantages of using templates in C++?**
...
**40. How can you handle memory leaks in C++?**
...
**41. Explain the concept of RAII (Resource Acquisition Is Initialization) in C++?**
...
**42. What is the difference between a class template and a function template?**
...
**43. Describe the role of the `explicit` keyword in C++?**
...
**44. What is the `volatile` keyword used for in C++?**
...
**45. How can you prevent inheritance in C++?**
...
**46. Discuss the differences between `new` and `malloc`.**
...
**47. How are private and protected inheritance different from public inheritance?**
...
**48. Explain the diamond problem in the context of multiple inheritance.**
...
**49. What are lambda expressions in C++? Provide an example.**
...
**50. Describe the use of `std::move` and move constructors/move assignment operators.**
